...
class WaveformGeneratorPPE(object):
    ...
    def _calculate_strain(self, model, model_data_points, transformation_function, transformed_model,
        ...
        model_strain['plus'] = apply_ppe_correction(model_strain['plus'],self.frequency_array,total_mass,beta,parameters['b'],delta_epsilon,0.018,0.75,True)
        model_strain['cross'] = apply_ppe_correction(model_strain['cross'],self.frequency_array,total_mass,beta,parameters['b'],delta_epsilon,0.018,0.75,True)
